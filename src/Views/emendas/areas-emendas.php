            ...
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    <p class="card-text mb-0">
                        Nesta seção, é possível adicionar e editar as áreas de emendas,
                        garantindo a organização correta dessas informações no sistema.
                    </p>
                </div>
            </div>
            ...
            <div class="card mb-2">
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = EmendaController::novaAreaDeEmenda($dados);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-3 col-12">
                            <input type="text" class="form-control form-control-sm" name="nome" placeholder="Nome da Área" required>
                        </div>
                        <div class="col-md-2 col-12">
                            <button type="submit" class="btn btn-success btn-sm confirm-action" data-message="Tem certeza que deseja inserir essa área de emenda?" name="btn_salvar">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover custom-table table-bordered table-striped mb-0">
                            ...
                            <tbody>
                                ...
                                $buscaAreas = EmendaController::listarAreasDeEmendas($_SESSION['usuario']['gabinete_id']);

                                if ($buscaAreas['status'] == 'success') {
                                    foreach ($buscaAreas['data'] as $area) {
                                        $usuario = UsuarioController::buscarUsuario($area['usuario_id'])['data']['nome'] ?? 'Sistema';
                                        echo '<tr>
                                ...
                                } else if ($buscaAreas['status'] == 'empty') {
                                    echo '<tr><td colspan="2">' . $buscaAreas['message'] . '</td></tr>';
                                } else if ($buscaAreas['status'] == 'server_error') {
                                    echo '<tr><td colspan="2">' . $buscaAreas['message'] . ' | ' . $buscaAreas['error_id'] . '</td></tr>';
                                }
                                ?>
                            </tbody>
                        </table>
