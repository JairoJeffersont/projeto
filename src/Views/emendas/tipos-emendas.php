        ...
        <div class="container-fluid p-2">
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    <p class="card-text mb-0">Nesta seção, é possível adicionar e editar os tipos de emendas, garantindo a organização correta dessas informações no sistema.</p>
                </div>
            </div>
            <div class="card mb-2">
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = EmendaController::novoTipodeEmenda($dados);
                            ...
                            <tbody>
                                ...
                                if ($buscaTipo['status'] == 'success') {
                                    foreach ($buscaTipo['data'] as $tipo) {
                                        $usuario = isset(UsuarioController::buscarUsuario($tipo['usuario_id'])['data']['nome']) ? UsuarioController::buscarUsuario($tipo['usuario_id'])['data']['nome'] : 'Sistema';
