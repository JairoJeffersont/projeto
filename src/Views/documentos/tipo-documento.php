...
$id = $_GET['id'] ?: '';
$buscaTipo = DocumentoController::buscarTipoDocumento($id);
            ...
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = DocumentoController::atualizarTipo($id, $dados);
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_apagar'])) {
                        ...
                        $result = DocumentoController::apagarTipodeDocumento($id);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        ...
                        <div class="col-md-10 col-12">
                            <button type="submit" class="btn btn-success btn-sm confirm-action" data-message="Tem certeza que deseja atualizar esse tipo de documento?" name="btn_salvar"><i class="bi bi-floppy-fill"></i> Salvar</button>
                            <button type="submit" class="btn btn-danger btn-sm confirm-action" data-message="Tem certeza que deseja apagar esse tipo de documento?" name="btn_apagar"><i class="bi bi-floppy-fill"></i> Apagar</button>
                        </div>
                    </form>
                </div>
            </div>
