        ...
        <div class="container-fluid p-2">
            ...
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    <p class="card-text mb-0">Nesta seção, é possível adicionar e editar os tipos de documentos, garantindo a organização correta dessas informações no sistema.</p>
                </div>
            </div>
            <div class="card mb-2">
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = DocumentoController::novoTipodeDocumento($dados);
                            ...
                            <tbody>
                                ...
                                if ($buscaTipo['status'] == 'success') {
                                    foreach ($buscaTipo['data'] as $tipo) {
                                        ...
                                        echo '<tr><td><a href="?secao=tipo-documento&id=' . $tipo['id'] . '">' . $tipo['nome'] . '</a></td><td>' . $usuario . ' | ' . date('d/m - H:i', strtotime($tipo['created_at'])) . '</td></tr>';
                                    }
