            ...
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = PessoaController::atualizarTipo($id, $dados);
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_apagar'])) {
                        ...
                        $result = PessoaController::apagarTipodeOrgao($id);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        ...
                        <div class="col-md-10 col-12">
                            <button type="submit" class="btn btn-success btn-sm confirm-action" data-message="Tem certeza que deseja atualizar esse tipo de pessoa?" name="btn_salvar"><i class="bi bi-floppy-fill"></i> Salvar</button>
                            <button type="submit" class="btn btn-danger btn-sm confirm-action" data-message="Tem certeza que deseja apagar esse tipo de pessoa?" name="btn_apagar"><i class="bi bi-floppy-fill"></i> Apagar</button>
                        </div>
                    </form>
                </div>
            </div>
