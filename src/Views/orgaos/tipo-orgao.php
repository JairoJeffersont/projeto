            ...
            <div class="card mb-2">
                ...
                <div class="card-body custom-card-body p-2">
                    ...
                    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['btn_salvar'])) {
                        ...
                        $result = OrgaoController::atualizarTipo($id, $dados);
                    ...
                    <form class="row g-2 form_custom" id="form_novo" method="POST">
                        <div class="col-md-2 col-12">
                            <input type="text" class="form-control form-control-sm" name="nome" placeholder="Nome do Tipo" value="<?php echo $buscaOrgao['data']['nome'] ?>" required>
                        </div>
                        <div class="col-md-1 col-12">
                            ...
                            <button type="submit" class="btn btn-danger btn-sm confirm-action" data-message="Tem certeza que deseja apagar esse tipo de órgão?" name="btn_apagar"><i class="bi bi-floppy-fill"></i> Apagar</button>
                        </div>
                    </form>
                </div>
            </div>
