 <div class="border-end bg-white" id="sidebar-wrapper">
     ...
     <div class="list-group list-group-flush">
         ...
         <a class="list-group-item list-group-item-action list-group-item-light px-4 loading-modal" href="?secao=deputados"><i class="bi bi-people-fill"></i> Deputados</a>
         <a class="list-group-item list-group-item-action list-group-item-light px-4 loading-modal" href="?secao=senadores"><i class="bi bi-people-fill"></i> Senadores</a>
